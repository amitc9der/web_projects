...
var ASM_CONSTS = {
  93192: () => { if (document.fullscreenElement) return 1; },  
 93238: () => { return Module.canvas.width; },  
 93270: () => { return parseInt(Module.canvas.style.width); },  
 93318: () => { document.exitFullscreen(); },  
 93345: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93418: () => { if (document.fullscreenElement) return 1; },  
 93464: () => { return Module.canvas.width; },  
 93496: () => { return screen.width; },  
 93521: () => { document.exitFullscreen(); },  
 93548: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93681: () => { return window.innerWidth; },  
 93707: () => { return window.innerHeight; },  
 93734: () => { if (document.fullscreenElement) return 1; },  
 93780: () => { return Module.canvas.width; },  
 93812: () => { return parseInt(Module.canvas.style.width); },  
 93860: () => { if (document.fullscreenElement) return 1; },  
 93906: () => { return Module.canvas.width; },  
 93938: () => { return screen.width; },  
 93963: () => { return window.innerWidth; },  
 93989: () => { return window.innerHeight; },  
 94016: () => { if (document.fullscreenElement) return 1; },  
 94062: () => { return Module.canvas.width; },  
 94094: () => { return screen.width; },  
 94119: () => { document.exitFullscreen(); },  
 94146: () => { if (document.fullscreenElement) return 1; },  
 94192: () => { return Module.canvas.width; },  
 94224: () => { return parseInt(Module.canvas.style.width); },  
 94272: () => { document.exitFullscreen(); },  
 94299: ($0) => { Module.canvas.style.opacity = $0; },  
 94337: () => { return screen.width; },  
 94362: () => { return screen.height; },  
 94388: () => { return window.screenX; },  
 94415: () => { return window.screenY; },  
 94442: () => { return window.devicePixelRatio; },  
 94478: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94531: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94582: () => { Module.canvas.style.cursor = 'none'; },  
 94619: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94875: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94926: () => { if (document.pointerLockElement) return 1; },  
 94973: () => { if (document.fullscreenElement) return 1; },  
 95019: () => { return window.innerWidth; },  
 95045: () => { return window.innerHeight; }
};
